import  requests
from  cfg import  g_vcode,g_schoolclass_api_path
from pprint import pprint
from robot.api import  logger
from robot.libraries.BuiltIn import BuiltIn

class SchoolClassLib:
    URL = g_schoolclass_api_path
    ...
    def list_school_class(self,gradeid = None):
        if gradeid != None:
            ...
            params = {
                "vcode": g_vcode,
                "acion": "list_classes_by_schoolgrade"
                   }
...
if __name__ ==  "__main__":
    scm = SchoolClassLib()
    scm.add_school_class(1,"实验1班",60)
    scm.list_school_class(1)